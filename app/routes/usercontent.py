...
async def get_my_recipes(
    ...
    return [RecipeResponse.model_validate({**recipe.__dict__, 'user_nickname': current_user.nickname, 'user_image_url': current_user.image_url}) for recipe in recipes]
...
async def get_my_posts(
    ...
    return [PostResponse.model_validate({**post.__dict__, 'user_nickname': current_user.nickname, 'user_image_url': current_user.image_url}) for post in posts]